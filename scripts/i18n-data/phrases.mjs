...
const KW = {
	...
	game: 'Dune Awakening',
	checkout: 'Zadeyo',
	eac: 'Dune Awakening BattlEye anti-cheat',
};
...
export const phrases = {
	es: {
		buy: 'Obtener acceso', undetected: 'indetectables', maps: 'supervivencia, multijugador y mundo abierto',
		...
		legal: () => 'Contacta support@duneawakeningcheats.com para solicitudes legales o de soporte.',
	},
	fr: {
		buy: 'Obtenir l\'accès', undetected: 'indétectables', maps: 'survie, multijoueur et monde ouvert',
		...
		legal: () => 'Contactez support@duneawakeningcheats.com pour le support ou les demandes légales.',
	},
	de: {
		buy: 'Zugang erhalten', undetected: 'unentdeckt', maps: 'Survival, Multiplayer und Open World',
		...
		legal: () => 'support@duneawakeningcheats.com für Support und rechtliche Anfragen.',
	},
	pt: {
		buy: 'Comprar Dune Awakening Cheats', undetected: 'indetectáveis', maps: 'loot objectives, faction raid spawn routes, and loot objectives',
		...
		legal: () => 'Contacte support@duneawakeningcheats.com para suporte ou questões legais.',
	},
	it: {
		buy: 'Acquista Dune Awakening Cheats', undetected: 'indetectable', maps: 'loot objectives, faction raid spawn routes, and loot objectives',
		...
		legal: () => 'Contatta support@duneawakeningcheats.com per supporto o richieste legali.',
	},
	nl: {
		buy: 'Dune Awakening Cheats kopen', undetected: 'undetected', maps: 'loot objectives, faction raid spawn routes, and loot objectives',
		...
		legal: () => 'support@duneawakeningcheats.com voor support en juridische vragen.',
	},
	pl: {
		buy: 'Kup Dune Awakening Cheats', undetected: 'undetected', maps: 'loot objectives, faction raid spawn routes, and loot objectives',
		...
		legal: () => 'support@duneawakeningcheats.com w sprawach wsparcia i prawnych.',
	},
	ru: {
		buy: 'Купить Dune Awakening Cheats', undetected: 'undetected', maps: 'loot objectives, faction raid spawn routes, and loot objectives',
		...
		legal: () => 'support@duneawakeningcheats.com для поддержки и юридических вопросов.',
	},
	tr: {
		buy: 'Dune Awakening Cheats satın al', undetected: 'undetected', maps: 'loot objectives, faction raid spawn routes, and loot objectives',
		...
		legal: () => 'Destek ve yasal sorular için support@duneawakeningcheats.com.',
	},
	ar: {
		buy: 'اشترِ Dune Awakening Cheats', undetected: 'غير مكتشف', maps: 'loot objectives, faction raid spawn routes, and loot objectives',
		...
		legal: () => 'support@duneawakeningcheats.com للدعم والطلبات القانونية.',
	},
	ja: {
		buy: 'Dune Awakening Cheatsを購入', undetected: 'undetected', maps: 'loot objectives, faction raid spawn routes, and loot objectives',
		...
		legal: () => 'サポート・法務: support@duneawakeningcheats.com',
	},
	ko: {
		buy: 'Dune Awakening Cheats 구매', undetected: 'undetected', maps: 'loot objectives, faction raid spawn routes, and loot objectives',
		...
		legal: () => '지원 및 법무: support@duneawakeningcheats.com',
	},
	zh: {
		buy: '购买 Dune Awakening Cheats', undetected: 'undetected', maps: 'loot objectives, faction raid spawn routes, and loot objectives',
		...
		legal: () => '支持与法务：support@duneawakeningcheats.com',
	},
	hi: {
		buy: 'Dune Awakening Cheats खरीदें', undetected: 'undetected', maps: 'loot objectives, faction raid spawn routes, and loot objectives',
		...
		legal: () => 'सहायता: support@duneawakeningcheats.com',
	},
	id: {
		buy: 'Beli Dune Awakening Cheats', undetected: 'undetected', maps: 'loot objectives, faction raid spawn routes, and loot objectives',
		...
		legal: () => 'support@duneawakeningcheats.com untuk dukungan dan legal.',
	},
	th: {
		buy: 'ซื้อ Dune Awakening Cheats', undetected: 'undetected', maps: 'loot objectives, faction raid spawn routes, and loot objectives',
		...
		legal: () => 'support@duneawakeningcheats.com สำหรับการสนับสนุน',
	},
	vi: {
		buy: 'Mua Dune Awakening Cheats', undetected: 'undetected', maps: 'loot objectives, faction raid spawn routes, and loot objectives',
		...
		legal: () => 'support@duneawakeningcheats.com cho hỗ trợ và pháp lý.',
	},
	uk: {
		buy: 'Купити Dune Awakening Cheats', undetected: 'undetected', maps: 'loot objectives, faction raid spawn routes, and loot objectives',
		...
		legal: () => 'support@duneawakeningcheats.com для підтримки та правових питань.',
	},
	cs: {
		buy: 'Koupit Dune Awakening Cheats', undetected: 'undetected', maps: 'loot objectives, faction raid spawn routes, and loot objectives',
		...
		legal: () => 'support@duneawakeningcheats.com pro podporu a právní dotazy.',
	},
	ro: {
		buy: 'Cumpără Dune Awakening Cheats', undetected: 'undetected', maps: 'loot objectives, faction raid spawn routes, and loot objectives',
		...
		legal: () => 'support@duneawakeningcheats.com pentru suport și legal.',
	},
	sv: {
		buy: 'Köp Dune Awakening Cheats', undetected: 'undetected', maps: 'loot objectives, faction raid spawn routes, and loot objectives',
		...
		legal: () => 'support@duneawakeningcheats.com för support och juridik.',
	},
};
