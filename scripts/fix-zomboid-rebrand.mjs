...
const FIXES = [
	...
	["from './project-zomboid'", "from './dune'"],
	...
	['Grineer, Corpus, and special infected', 'players, NPCs, and special infected'],
	['Grineer and Corpus units', 'players and NPCs'],
	['Grineer, Corpus', 'players, NPCs'],
	['Grineer heavy unit', 'special infected'],
	['Corpus-heavy', 'special infected-heavy'],
	['Corpus MOAs', 'zombie runners'],
	['Infested runners', 'zombie sand ambushers'],
	['hero boxes', 'enemy boxes'],
	['hero skeleton', 'enemy skeleton'],
