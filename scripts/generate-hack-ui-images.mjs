 ...
 * Not combat stock photos — product/HUD visuals for Dune Awakening Cheats SEO filenames.
 */
...
const ASSETS = {
	'dune-awakening-cheats-hero.webp': heroSvg,
	'dune-awakening-cheats-cover.webp': coverSvg,
	'dune-awakening-esp-overlay.webp': espSvg,
	'dune-awakening-aimbot-ui.webp': aimbotSvg,
	'dune-awakening-wallhack-ui.webp': wallhackSvg,
	'dune-awakening-cheats-menu.webp': menuSvg,
	'dune-awakening-cheats-status.webp': statusSvg,
	'dune-awakening-radar-ui.webp': radarSvg,
	'dune-awakening-soft-aim-ui.webp': softAimSvg,
	'dune-awakening-cheats-panel.webp': panelSvg,
	'dune-awakening-cheats-dashboard.webp': dashboardSvg,
	'dune-awakening-cheats-logo.webp': null, // derived from hero
};
...
function heroSvg() {
  ...
  <text x="120" y="292" fill="#fff" font-family="Segoe UI, Arial, sans-serif" font-size="20" font-weight="700">BUY Dune Awakening Cheats</text>
...
function coverSvg() {
	return frame(
		'Dune Awakening Cheats PACKAGE',
		`
  <rect x="200" y="180" width="1200" height="520" rx="16" fill="url(#panel)" stroke="#c4784055" stroke-width="2"/>
  <text x="260" y="300" fill="#f2ebe3" font-family="Segoe UI, Arial, sans-serif" font-size="72" font-weight="800">Dune Awakening Cheats</text>
...
function statusSvg() {
  ...
  <text x="560" y="520" fill="#d4a574" font-family="Consolas, monospace" font-size="16">Dune Awakening Cheats · status panel</text>`,
	);
}
...
function dashboardSvg() {
  ...
  <text x="120" y="190" fill="#f2ebe3" font-family="Segoe UI, Arial, sans-serif" font-size="28" font-weight="700">Dune Awakening Cheats dashboard</text>
...
for (const [file, factory] of Object.entries(ASSETS)) {
	...
	if (file === 'dune-awakening-cheats-hero.webp') heroBuf = buf;
}

if (heroBuf) {
	const logo = await sharp(heroBuf).extract({ left: 860, top: 140, width: 512, height: 512 }).resize(512, 512).webp({ quality: 88 }).toBuffer();
	await writeFile(path.join(imagesDir, 'dune-awakening-cheats-logo.webp'), logo);
	...
	console.log('Wrote dune-awakening-cheats-logo.webp + favicons');
}
