#!/usr/bin/env node
/**
 * Download royalty-free Dune Awakening-atmosphere imagery (Unsplash) into public/images
...
const KEYWORD_ASSETS = [
	{ file: 'dune-awakening-cheats-hero.webp', url: 'https://images.unsplash.com/photo-1518709268805-4e9042af9f23?auto=format&fit=crop&w=1920&q=80' },
	{ file: 'dune-awakening-cheats-cover.webp', url: 'https://images.unsplash.com/photo-1504328345606-18bbc8c9d7d1?auto=format&fit=crop&w=1920&q=80' },
	...
	{ file: 'dune-awakening-cheats-aimbot-combat.webp', url: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?auto=format&fit=crop&w=1920&q=80' },
	...
	{ file: 'dune-awakening-cheats-esp-wallhack.webp', url: 'https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?auto=format&fit=crop&w=1920&q=80' },
	{ file: 'dune-awakening-cheats-package.webp', url: 'https://images.unsplash.com/photo-1441974231531-c6227db76b6e?auto=format&fit=crop&w=1920&q=80' },
...
async function fetchWebp(url) {
	const res = await fetch(url, {
		headers: { 'User-Agent': 'Mozilla/5.0 (compatible; Dune AwakeningHacksSite/1.0)' },
	});
...
async function generateBrandAssets(heroBuffer) {
	...
	await writeFile(path.join(imagesDir, 'dune-awakening-cheats-logo.webp'), logoBuffer);
...
for (const asset of KEYWORD_ASSETS) {
	...
	try {
		...
		if (asset.file === 'dune-awakening-cheats-hero.webp') heroBuffer = webp;
	} catch (err) {
...
console.log(`Done — attempted ${KEYWORD_ASSETS.length} Dune Awakening atmosphere images.`);
