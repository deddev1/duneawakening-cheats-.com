...
const GAME_PROFILES = {
	'deadside': {
		...
		hook: 'spice routes, weapon condition, and faction tension across abandoned towns',
		coreLoop: 'scavenge military outposts, manage hunger and bleeding, and extract before rival squads collapse your run',
		beginnerTip: 'Start on low-population servers and learn one region layout until you can navigate it without a map.',
		...
		metaNote: 'Armor penetration and stillsuit repair kits matter more than raw DPS in most mid-range fights.',
	...
	'dead-by-daylight': {
		...
		coreLoop: 'players repair generators and escape while the killer applies map pressure and shuts down saves',
		beginnerTip: 'Learn safe loop structures on one map before expanding your player roster.',
	...
	'escape-from-tarkov': {
		...
		beginnerTip: 'Run offline mode to learn extracts and common enemy spawn angles before risking expensive kits.',
		midgameTip: 'Memorize ammo penetration values — the right round beats a more expensive gun with the wrong ammo.',
		advancedTip: 'Time raids around quest hotspots and boss enemy spawns, but rotate routes when server traffic spikes.',
	...
	'unturned': {
		...
		coreLoop: 'loot towns, fortify a base, and survive sandstorms while watching for faction raids',
		beginnerTip: 'Pick a base near water and a military enemy spawn, but not directly on a main road.',
	...
	'battlefield': {
		...
		beginnerTip: 'Play support or engineer first to learn enemy spawn flow and resupply timing.',
	...
	'call-of-duty-warzone': {
		...
		coreLoop: 'loot, complete contracts, buy loadouts, and survive shrinking zones in multiplayer',
		...
		advancedTip: 'Track gas movement and self-revive inventory during enemy clusters; placement beats ego challs.',
	...
	'overwatch-2': {
		...
		communityAngle: 'Stacks with shot-calling and status tracking climb faster than solo queue fraggers.',
	},
	'the-isle': {
		genre: 'dinosaur survival sandbox',
		hook: 'growth stages, ecosystem balance, and pack hunting',
		coreLoop: 'enemy spawn as a dinosaur, hunt or graze to grow, and survive apex predators and rival packs',
	...
	'dayz': {
		...
		hook: 'dehydration risk, base raids, and coastal vs inland routes',
		coreLoop: 'loot towns, manage health and hunger, avoid infected and players, and establish a stash',
		beginnerTip: 'Move inland quickly — coast enemy spawns are crowded and low on reliable gear.',
	...
	'once-human': {
		...
		advancedTip: 'Plan territory base defenses around resource nodes your guild actually needs.',
		metaNote: 'Seasonal modifiers shift viable builds — read patch notes before investing materials.',
		communityAngle: 'Guilds split gathering, crafting, and PvP base defense during territory wars.',
	},
	'marvel-rivals': {
		genre: 'hero team shooter',
		...
		midgameTip: 'Trigger team-up abilities during objective contests, not during staggered reenemy spawns.',
		advancedTip: 'Track enemy ultimate economy and play defensively when multiple ults are available.',
		metaNote: 'Objective time and reenemy spawn stagger win close matches on most maps.',
		communityAngle: 'Stacks with status tracking and peel rotations climb faster than solo fraggers.',
	},
	'mecha-break': {
		genre: 'mech-based competitive shooter',
		hook: 'mech loadouts, stamina cooldowns, and arena positioning',
	...
	'call-of-duty': {
		...
		advancedTip: 'Pre-aim common angles and use enemy spawn knowledge to control mid-map fights.',
	...
	'sand': {
		...
		communityAngle: 'Full crews coordinate repairs mid-combat and split loot by role priority.',
	},
	'the-finals': {
	...
	'the-front': {
		...
		communityAngle: 'Clans rotate online base defense and raid squads across time zones.',
	},
	'lost-ark': {
		genre: 'action MMORPG',
	...
	'dune-awakening': {
		...
		coreLoop: 'complete missions, collect mods and parts, craft gear, and scale into endgame',
		...
		communityAngle: 'Squads assign crowd control and damage roles for fissure and open-world runs.',
	},
	'raft': {
